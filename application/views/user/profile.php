<div class="right_col" role="main">
    ...
    <?php if ($this->session->flashdata('msg')) : ?>
        <!-- Jika ada pesan flashdata, tampilkan di sini -->
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('user/profile'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Nama Lengkap <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
